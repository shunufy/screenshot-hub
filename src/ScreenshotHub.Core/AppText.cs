...
public static class AppText
{
    ...
    public static string AutoRescan => English ? "Rescan automatically" : "自動で再スキャン";
    ...
    public static string Updated(DateTime local) => English ? $"Updated {local:HH:mm}" : $"更新 {local:HH:mm}";
