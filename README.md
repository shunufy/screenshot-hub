...
Open the [v0.2.0 release](../../releases/tag/v0.2.0), then choose a language:

- `ScreenshotHub-0.2.0-en-US-win-x64.zip` — English UI
- `ScreenshotHub-0.2.0-ja-JP-win-x64.zip` — Japanese UI
...
- Automatic startup scan and optional scheduled rescans
...
- The image catalog is rebuilt during scans rather than stored remotely.
...
- WebP is not supported in v0.2.0.
