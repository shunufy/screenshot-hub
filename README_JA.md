...
[v0.2.0 Release](../../releases/tag/v0.2.0) を開き、使用する言語を選びます。

- `ScreenshotHub-0.2.0-ja-JP-win-x64.zip` — 日本語UI
- `ScreenshotHub-0.2.0-en-US-win-x64.zip` — 英語UI
